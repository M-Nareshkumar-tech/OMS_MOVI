...
import {
  ...
  getInternRequests, updateInternRequestStatus,
...
router.get('/requests', requirePermission('Interns', 'read'), getInternRequests);
router.patch('/requests/:id', requirePermission('Interns', 'manage'), updateInternRequestStatus);
